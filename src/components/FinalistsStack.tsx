  ...
  return (
    <>
        ...
        {finalists.map((team, index) => {
          ...
          return (
            <motion.div
              ...
              style={{
                zIndex: finalists.length - index,
              }}
              initial={{ y: offset, rotateZ: rotation, opacity: 0, scale: 0.9 }}
              animate={{ y: offset, rotateZ: rotation, opacity: 1, scale: 1 }}
      ...
      <Dialog open={!!selectedTeam} onOpenChange={() => setSelectedTeam(null)}>
        <DialogContent className="bg-gradient-to-br from-background/95 to-background/80 backdrop-blur-xl border-2 border-primary/30">
          <DialogHeader>
